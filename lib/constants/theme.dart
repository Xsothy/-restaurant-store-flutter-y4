...
class AppTheme {
  ...
  static const Color secondaryColor = Color(0xFFF7931E); // Amber
  static const Color secondaryVariant = Color(0xFFDC7F0A);
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      // Other themes remain similar but adapted for dark mode...
    );
  }
}
